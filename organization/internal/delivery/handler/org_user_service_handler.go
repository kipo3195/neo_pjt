...
type OrgUserServiceHandler struct {
	svc *orchestrator.OrgUserService
}

func NewOrgUserServiceHandler(svc *orchestrator.OrgUserService) *OrgUserServiceHandler {
	return &OrgUserServiceHandler{
		svc: svc,
	}
}

func (h *OrgUserServiceHandler) GetMyInfo(c *gin.Context) {
	...
	output, err := h.svc.User.GetMyInfo(ctx, myInfoInput)
...
func (h *OrgUserServiceHandler) GetUserInfo(c *gin.Context) {
	...
	output, err := h.svc.User.GetUserInfo(ctx, input)
