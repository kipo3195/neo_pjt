...
type skinImgUsecase struct {
	repository clientRepository.SkingImgRepository
}

type SkinImgUsecase interface {
	CreateSkinImg(ctx context.Context, body requestDTO.CreateSkinImgRequestBody) error
}

func NewSkinImgUsecase(repository clientRepository.SkingImgRepository) SkinImgUsecase {
	return &skinImgUsecase{
		repository: repository,
	}
}

func (r *skinImgUsecase) CreateSkinImg(ctx context.Context, body requestDTO.CreateSkinImgRequestBody) error {
...
func skinImgforwardToCommon(ctx context.Context, body requestDTO.CreateSkinImgRequestBody) bool {
	log.Println("44")
