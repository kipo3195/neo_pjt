...
type RegisterDeptRequestDTO struct {
	Header RegisterDeptRequestHeader
	Body   RegisterDeptRequestBody
}

type RegisterDeptRequestBody struct {
...
type RegisterDeptRequestHeader struct {
}
