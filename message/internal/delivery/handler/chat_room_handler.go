...
func (r *ChatRoomHandler) CreateChatRoom(c *gin.Context) {
	...
	regDate, err := r.usecase.CreateChatRoom(ctx, input)
...
func (r *ChatRoomHandler) GetChatRoomDetail(c *gin.Context) {
	...
	output, err := r.usecase.GetChatRoomDetail(ctx, input)
...
func (r *ChatRoomHandler) GetChatRoomList(c *gin.Context) {
	ctx := c.Request.Context()
	...
	output, err := r.usecase.GetChatRoomList(ctx, input)
