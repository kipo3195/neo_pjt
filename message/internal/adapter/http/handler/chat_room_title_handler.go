...
func (h *ChatRoomTitleHandler) UpdateChatRoomTitle(c *gin.Context) {
	...
	input := mapper.MakeUpdateChatRoomTitleInput(userHash, req.Org, req.RoomKey, req.Type, req.Title)
...
func (h *ChatRoomTitleHandler) DeleteChatRoomTitle(c *gin.Context) {
	...
	input := mapper.MakeDeleteChatRoomTitleInput(userHash, req.Org, req.RoomKey, req.Type)
