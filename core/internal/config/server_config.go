...
import (
	appValidationModels "core/internal/domains/appValidation/models"
	"log"
	"os"
...
func ConnectDatabase(sfg *ServerConfig) *gorm.DB {
	...
	/* 마이그레이션 */
	db.AutoMigrate(&appValidationModels.AppValidation{})
	db.AutoMigrate(&appValidationModels.WorksList{})
