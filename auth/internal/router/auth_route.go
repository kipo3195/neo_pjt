...
func SetLoginRoutes(parent *gin.RouterGroup, handlers *certification.CertificationHandlers) {
...
func SetTokenRoutes(parent *gin.RouterGroup, handlers *token.TokenHandlers) {
